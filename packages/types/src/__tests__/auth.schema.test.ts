...
describe("auth.schema", () => {
  describe("loginSchema", () => {
    it("parses valid input", () => {
      ...
      expectTypeOf(parsed).toMatchTypeOf<LoginFormData>();
    });
  ...
  describe("registerSchema", () => {
    ...
    it("parses valid input and supports password boundaries", () => {
      ...
      expectTypeOf(parsed).toMatchTypeOf<RegisterFormData>();
  ...
  describe("forgotPasswordSchema", () => {
    it("parses valid input", () => {
      ...
      expectTypeOf(parsed).toMatchTypeOf<ForgotPasswordFormData>();
    });
  ...
  describe("verifyEmailSchema", () => {
    it("parses valid input", () => {
      ...
      expectTypeOf(parsed).toMatchTypeOf<VerifyEmailFormData>();
    });
  ...
  describe("resetPasswordSchema", () => {
    ...
    it("parses valid input", () => {
      ...
      expect(parsed).toEqual(validInput);
      expectTypeOf(parsed).toMatchTypeOf<ResetPasswordFormData>();
    });
  ...
  describe("acceptInviteSchema", () => {
    ...
    it("parses valid input", () => {
      ...
      expect(parsed).toEqual(validInput);
      expectTypeOf(parsed).toMatchTypeOf<AcceptInviteFormData>();
    });
