...
export interface RequestWorkflowActivity {
    ...
    tenantId: string;
    requestId: string;
    type: "REQUEST_CREATED" | "STATUS_CHANGED" | "ASSIGNED" | "REASSIGNED" | "COMMENT_ADDED" | "INTERNAL_NOTE_ADDED" | "SLA_WARNING" | "SLA_BREACHED" | "RESOLUTION_SUBMITTED";
    eventType: "REQUEST_CREATED" | "STATUS_CHANGED" | "REQUEST_ASSIGNED" | "REQUEST_REASSIGNED" | "COMMENT_ADDED" | "WORK_LOG_ADDED" | "SLA_AT_RISK" | "SLA_BREACHED" | "REQUEST_ESCALATED" | "REQUEST_RESOLVED" | "REQUEST_CLOSED" | "REQUEST_REOPENED" | "REQUEST_CANCELLED" | string;
    title: string;
