...
function SelectOptionFieldInner(props) {
      ...
      StyledTextField,
      {
        ...
        SelectProps: {
          ...
          renderValue: (selected) => {
            ...
            return /* @__PURE__ */ jsxRuntime.jsx("span", { children: options.find((o) => o.value === selected)?.label ?? String(selected) });
          }
        },
        select: true,
        value: field.value ?? "",
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Box4__default.default, { sx: { width: "100%" }, children: [
    ...
    showHelper ? /* @__PURE__ */ jsxRuntime.jsx(StyledHelperText, { error: Boolean(error), children: helperTextContent }) : null
  ] });
}
...
function TextInputFieldInner(props) {
  ...
  const startAdornment = react.useMemo(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(InputAdornment__default.default, { position: "start", children: startIcon });
  }, [startIcon]);
  const endAdornment = react.useMemo(() => {
    ...
    const statusOverlay = statusIcon ? /* @__PURE__ */ jsxRuntime.jsx(
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      statusOverlay,
      /* @__PURE__ */ jsxRuntime.jsx(InputAdornment__default.default, { position: "end", children: /* @__PURE__ */ jsxRuntime.jsx(Box4__default.default, { sx: { display: "inline-flex", alignItems: "center" }, children: resolvedEndIcon }) })
    ] });
  }, [
    endIcon,
    errorIcon,
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            Box4__default.default,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(Button__default.default, { onClick: handleClear, size: "small", sx: { color: "text.secondary" }, variant: "text", children: uiTexts.clearLabel })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsx(Box4__default.default, { sx: { px: 1.5, pb: 1.5 }, children: /* @__PURE__ */ jsxRuntime.jsx(Typography__default.default, { sx: { fontSize: 11, color: "text.disabled" }, children: uiTexts.keyboardHint }) })
        ]
      }
    )
  ] });
