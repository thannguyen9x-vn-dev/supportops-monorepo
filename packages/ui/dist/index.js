...
function useDataTable(options) {
  ...
  const columnOrder = externalColumnOrder !== void 0 ? externalColumnOrder : internalColumnOrder;
  const setColumnOrder = externalOnColumnOrderChange !== void 0 ? externalOnColumnOrderChange : setInternalColumnOrder;
  const columnSizing = externalColumnSizing !== void 0 ? externalColumnSizing : internalColumnSizing;
  const setColumnSizing = externalOnColumnSizingChange !== void 0 ? externalOnColumnSizingChange : setInternalColumnSizing;
...
function getStickyStyle(pinned, offsetLeft, offsetRight, background, zIndex, isBoundary = false) {
  if (!pinned) return {};
  return {
    position: "sticky",
                      ...
                      /* @__PURE__ */ jsx(
                        "thead",
                        {
                          ...
                          children: table.getHeaderGroups().map((headerGroup) => /* @__PURE__ */ jsx("tr", { children: headerGroup.headers.map((header, headerIndex) => {
                            ...
                            const isBoundary = header.column.id === lastLeftPinnedId || header.column.id === firstRightPinnedId;
                            return /* @__PURE__ */ jsx(
                              "th",
                              {
                                ...
                                onDragLeave: canReorder ? () => setDragOverColumnId(null) : void 0,
                                onDrop: canReorder ? (e) => {
                                  e.preventDefault();
                                  ...
                                  const currentOrder = table.getState().columnOrder.length > 0 ? table.getState().columnOrder : table.getAllLeafColumns().map((c) => c.id);
                                ...
                                style: {
                                  ...
                                  borderBottom: "1px solid var(--mui-palette-divider)",
                                  boxShadow: isDragOver ? "inset 2px 0 0 var(--mui-palette-primary-main)" : void 0,
                                  ...getStickyStyle(
                                    pinned,
                                ...
                                children: useInnerWrapper ? (
                                  ...
                                  /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", height: "100%", padding: canReorder ? "0 0 0 4px" : "0 0 0 16px" }, children: [
                                    canReorder && /* @__PURE__ */ jsx(
                                      "div",
                                      {
                                        ...
                                        children: /* @__PURE__ */ jsxs("svg", { width: "10", height: "16", viewBox: "0 0 10 16", fill: "currentColor", "aria-hidden": "true", children: [
                                          /* @__PURE__ */ jsx("circle", { cx: "3", cy: "4.5", r: "1.2" }),
                                          /* @__PURE__ */ jsx("circle", { cx: "7", cy: "4.5", r: "1.2" }),
                                          /* @__PURE__ */ jsx("circle", { cx: "3", cy: "8", r: "1.2" }),
                                          /* @__PURE__ */ jsx("circle", { cx: "7", cy: "8", r: "1.2" }),
                                          /* @__PURE__ */ jsx("circle", { cx: "3", cy: "11.5", r: "1.2" }),
                                          /* @__PURE__ */ jsx("circle", { cx: "7", cy: "11.5", r: "1.2" })
                                        ] })
                                      }
                                    ),
                                    /* @__PURE__ */ jsx("div", { style: { flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", minWidth: 0 }, children: header.isPlaceholder ? null : flexRender(header.column.columnDef.header, header.getContext()) }),
                        ...
                        return /* @__PURE__ */ jsx(
                          "tr",
                          {
                            ...
                            children: row.getVisibleCells().map((cell, cellIndex) => {
                              ...
                              const isBoundary = cell.column.id === lastLeftPinnedId || cell.column.id === firstRightPinnedId;
                              return /* @__PURE__ */ jsx(
                                "td",
                                {
                                  style: {
              ...
              title || titleElement ? /* @__PURE__ */ jsxs("div", { className: "relative border-b px-6 py-4", children: [
                ...
                showCloseButton ? /* @__PURE__ */ jsx(
                  "button",
                  {
                    ...
                    onClick: onClose,
                    type: "button",
                    children: /* @__PURE__ */ jsx("svg", { "aria-hidden": "true", fill: "none", height: "16", stroke: "currentColor", strokeWidth: "2", viewBox: "0 0 16 16", width: "16", children: /* @__PURE__ */ jsx("path", { d: "M2 2l12 12M14 2L2 14", strokeLinecap: "round" }) })
                  }
                ) : null
              ] }) : null,
              /* @__PURE__ */ jsx("div", { className: cn("px-6 py-5", dividers ? "border-b border-t" : "", scrollable ? "overflow-y-auto max-h-[70vh]" : ""), children }),
