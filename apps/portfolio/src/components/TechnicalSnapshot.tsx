          ...
          <table className="w-full text-sm">
            <tbody>
              {technical.stack.map((row, i) => (
                ...
                >
                  <td className="px-5 py-3.5 w-36 font-medium text-zinc-400 whitespace-nowrap align-top">
                    {row.layer}
                  </td>
                  <td className="px-5 py-3.5 text-zinc-300 font-mono text-xs leading-relaxed">
                    {row.value}
                  </td>
                </tr>
              ))}
