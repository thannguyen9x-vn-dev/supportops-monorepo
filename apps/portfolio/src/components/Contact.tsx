...
export function Contact() {
  ...
  return (
    <section id={contact.id} className="py-20 px-6 border-t border-zinc-800">
      <div className="mx-auto max-w-5xl">
        <h2 className="text-2xl font-semibold text-zinc-50 mb-3">
          {contact.heading}
        </h2>
        <p className="text-zinc-400 max-w-xl mb-10">{contact.intro}</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          {contact.links.map((link) => (
            <a
              ...
              className="flex items-center gap-3 rounded-lg border border-zinc-800 bg-surface px-5 py-4 hover:border-zinc-600 hover:bg-surface-raised transition-colors group"
            >
