...
export function RequestTabBar({ instance, isEnglishLocale, isVietnameseLocale }: RequestTabBarProps) {
  const sx = useMemo(
    () => ({
      ...
      ...(isVietnameseLocale && {
        "& .MuiTab-root:nth-of-type(1)": { width: 156 },
        "& .MuiTab-root:nth-of-type(2)": { width: 168 },
        "& .MuiTab-root:nth-of-type(3)": { width: 170 },
        "& .MuiTab-root:nth-of-type(4)": { width: 124 },
        "& .MuiTab-root:nth-of-type(5)": { width: 144 },
        "& .MuiTab-root:nth-of-type(6)": { width: 112 },
      }),
    }),
