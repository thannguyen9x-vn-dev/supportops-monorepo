...
export class BoardService {
  ...
  async create(tenantId: string, dto: CreateBoardDto): Promise<BoardResponseDto> {
  ...
  async update(tenantId: string, id: string, dto: UpdateBoardDto): Promise<BoardResponseDto> {
