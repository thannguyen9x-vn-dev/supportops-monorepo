...
export class InvoiceService {
  ...
  async create(tenantId: string, role: Role, dto: CreateInvoiceDto): Promise<InvoiceResponseDto> {
    this.ensureInvoiceAdminRole(role);
  ...
  async update(tenantId: string, role: Role, id: string, dto: UpdateInvoiceDto): Promise<InvoiceResponseDto> {
    this.ensureInvoiceAdminRole(role);
  ...
  async delete(tenantId: string, role: Role, id: string): Promise<void> {
    this.ensureInvoiceAdminRole(role);
  ...
  private ensureInvoiceAdminRole(role: Role): void {
